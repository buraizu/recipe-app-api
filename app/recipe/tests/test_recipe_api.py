...
def sample_ingredient(user, name='Cinnamon'):
    """Creaate and return a sample ingredient"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Nachos')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Fake burger')
        ingredient1 = sample_ingredient(user=self.user, name='Beans')
        ingredient2 = sample_ingredient(user=self.user, name='Bun')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Vegetables with sauce')
